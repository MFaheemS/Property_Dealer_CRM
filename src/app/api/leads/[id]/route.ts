...
const UpdateLeadSchema = z.object({
  ...
  propertyInterest: z.enum(["Residential Plot","Commercial Plot","House","Apartment","Farm House","Shop","Office","Warehouse","Duplex","Penthouse","Commercial Building"]).optional(),
  source:           z.enum(["Facebook Ads","Walk-in","Website Inquiry","Referral","Phone Call","Other"]).optional(),
